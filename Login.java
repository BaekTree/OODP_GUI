...
public class Login extends Application{
	...
	class TaskSpecificHandler implements EventHandler<ActionEvent>{
		private int index;
	...
	class RecordSpecificHandler implements EventHandler<ActionEvent>{
		private int index;
	...
	class SchSpecificHandler implements EventHandler<ActionEvent>{
		private int index;
...
class RecordPane extends GridPane{
...
class SchPane extends GridPane{
